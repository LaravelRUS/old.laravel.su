        ...
        return [
            ...
            Layout::rows([
                ...
                Input::make('email')
                    ...
                    ->help('Used to let the user enter and edit an e-mail location')
                    ->horizontal(),
                ...
                Input::make('url')
                    ...
                    ->horizontal()
                    ->help('You might use this when asking to input their website location for a business directory'),
