    ...
    'location' => 'Калинов Мост',
        ...
        <div class="col-md-6">
            <div class="mb-4 text-balance bg-body-tertiary rounded p-4 p-xl-5 position-relative"
                ...
                <p>По этому в помощь тебе я оставила несколько <abbr
    ...
    <div class="row">
        <div class="col-12 col-md-4">
            ...
            <p class="small text-muted mb-2 text-balance">
                ...
                Что бы не портить впечатления от игры коллегам, пожалуйста не раскрывайте тайны уже пройденных этапов в общих телеграм чатах или других
                группах.
            </p>
        </div>
