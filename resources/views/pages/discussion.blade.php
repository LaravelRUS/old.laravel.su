            ...
            <div class="col-xl-8 col-md-12 mx-auto">
                <div class="bg-body-tertiary mb-4 px-5 py-4">
                    ...
                    <div class="position-relative">
                        ...
                        <p>Hola Amigos! На связи Евгений Шмулевский, PHP-разработчик в Amiga. Начал заниматься
                            программированием с
                ...
                <div class="bg-body-tertiary mb-4 px-5 py-4">
                    ...
                    <div class="position-relative">
                        ...
                        <p>Часто разработчики интересуются почему не рекомендуется использовать тип поля <code>enum</code> в
                            базе данных, и в этой статье мы рассмотрим все плюсы и минусы данного типа.</p>
                    </div>
