    ...
    <x-container>
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-5">
                    ...
                    <p>Кодица - это уникальное событие, которое объединяет талантливых разработчиков, программистов и
                       креативных мыслителей. Это место, где идеи становятся реальностью, а коды превращаются в
                       функциональные приложения. Но помимо этого, хакатон - это еще и невероятно весело!
                    </p>

                    <p>Независимо от уровня ваших навыков, вы можете принять участие в этих соревнованиях, чтобы
        ...
        <div class="bg-body-secondary p-5 rounded-5 overflow-hidden">
            <div class="row gx-5 gy-4 gy-md-5 row-cols-1 row-cols-lg-3 align-items-baseline">
                <div class="col">
                    ...
                    <p>Создайте бесплатную учетную запись и выполните краткую оценку, чтобы помочь нам понять ваши потребности и предпочтения.</p>
                </div>
                <div class="col">
                    <p class="display-1 text-primary fw-bolder">2</p>
                    <h3 class="fs-2 fw-bolder">Персональные рекомендации</h3>
                    <hr class="w-25 text-primary">
                    <p>Получайте индивидуальные рекомендации по советам, стратегиям и действиям, направленным на улучшение вашего психического благополучия и эмоционального интеллекта.</p>
                </div>
                <div class="col">
                    <p class="display-1 text-primary fw-bolder">3</p>
                    <h3 class="fs-2 fw-bolder">Отслеживайте свой прогресс</h3>
                    <hr class="w-25 text-primary">
                    <p> Отслеживайте свой рост с помощью интуитивно понятных информационных панелей и аналитики, корректируя свои цели и предпочтения по мере необходимости.</p>
                </div>
                <div class="col">
                    <p class="display-1 text-primary fw-bolder">4</p>
                    <h3 class="fs-2 fw-bolder">Оставайтесь на связи</h3>
                    <hr class="w-25 text-primary">
                    <p> Регулярно получайте доступ к новому контенту и идеям, участвуйте в мероприятиях сообщества и делитесь своим путешествием с единомышленниками.</p>
                </div>
                <div class="col">
                    <p class="display-1 text-primary fw-bolder">5</p>
                    <h3 class="fs-2 fw-bolder">Стань лучше!</h3>
                    <hr class="w-25 text-primary">
                    <p> Получите доступ к расширенным функциям и индивидуальному коучингу с нашей премиальной подпиской, подняв свое психическое благополучие на новый уровень.</p>
                </div>
            </div>
        </div>
    </x-container>
