...
@section('content')
    ...
    <x-header align="align-items-end">
        <x-slot:sup>Советы по безопасности</x-slot>
            <x-slot:title>Советы по безопасности разработчикам</x-slot>

            <x-slot:description>
                У любого программного обеспечения есть жизненный цикл выпуска, которого необходимо
                придерживаться, чтобы продолжать продвигаться вперед и вносить улучшения.
            </x-slot>
    ...
    <x-container>
        ...
        <div class="row g-5 justify-content-center align-items-start position-relative mb-5">
            <div class="col-xl-4 position-sticky top-0 py-3">
                ...
                <h5 class="fs-4 mt-2  fw-semibold">Основы</h5>
                <p class="mb-0">
            ...
            <div class="col-xl-8">
                <main class="bg-body-tertiary p-xl-5 p-4 rounded shadow">
                    ...
                    <p>
                        ...
                        маршрутизации, а также оптимизацию кода фреймворка. Поддерживаемые версии Laravel обеспечивают
                        доступ к этим улучшениям, что в итоге улучшает общую производительность вашего приложения. Более
                        быстрое время отклика и повышенная эффективность работы кода способствуют улучшению
                        пользовательского опыта и общей удовлетворенности пользователя.
                    </p>
