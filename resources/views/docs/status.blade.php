...
@section('content')
    @php /** @var $version App\FrameworkVersion */ @endphp
                    ...
                    <table class="table-auto">
                        ...
                        @foreach($version->documentation as $i => $doc)
                            <tr>
                                ...
                                <td>
                                    <a class="link" href="https://github.com/laravel/docs/blob/{{ $doc->current_original_commit }}/{{ $doc->page }}.md">
                                ...
                                <td>
                                    <div class="flex flex-row">
                                        @if($doc->last_original_commit === null)
                                            <div class="w-6">&nbsp;</div>
                                            <div class="text-red-500"><i class="fa fa-circle"></i> перевод отсутствует
                                            </div>
                                        @else
                                            ...
                                            @else
                                                ...
                                                <div>git
                                                    difftool {{ substr($doc->last_original_commit, 0, 7) }} {{ substr($doc->current_original_commit, 0, 7) }} {{ $doc->page }}.md
                                                </div>
                                            @endif
                                        @endif
                                    </div>
